...
int main(int argc, char ** argv)
{
    ...
    corr_it=corr_map.begin(); corr_it != corr_map.end(); ++corr_it, ++i)
  {
    ...
    std::cout 
        << ": XX[" << i << "]:=" << bits(pattern.xx)
        << ": XY[" << i << "]:=" << bits(pattern.xy)
        << ": XX&XY[" << i << "]:=" << bits(pattern.xx & pattern.xy)
        << ": YY[" << i << "]:=" << bits(pattern.yy)
        << ": YX[" << i << "]:=" << bits(pattern.yx)
        << ": YY&YX[" << i << "]:=" << bits(pattern.yy & pattern.yx)
